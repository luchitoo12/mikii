...
function ap() {
    ...
    let c = [{
        ...
        id: 10,
        description: "vamoo dalee yo te amooo.",
    ...
    return se.jsx("main", {
        ...
        children: u ? se.jsxs("div", {
            ...
            children: [se.jsx("h1", {
                ...
                children: "Sabia ke ibas a decir ke si ❤️ te amoo muchisiimo amoorr!"
            }), se.jsx("img", {
                ...
                hidden: !0,
                children: document.title = "Sabia ke ibas decir ke si ❤️!"
            })]
        }) : se.jsxs("div", {
            className: "p-5",
            children: [se.jsx("h1", {
                className: "text-white font-bold text-5xl text-center",
                children: "Mikii keres ser mi San Valentin?"
            }), se.jsx("img", {
                ...
                children: [se.jsx("button", {
                    ...
                    children: [Object.keys(t).length === 0 ? "No" : t.description, se.jsx("span", {
                        hidden: !0,
                        children: document.title = Object.keys(t).length === 0 ? "para vos amoor<3" : t.description
                    })]
                })]
            })]
        })
